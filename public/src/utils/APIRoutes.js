...
export const postMediaStatusRoute  = api("/api/status/media");
export const viewStatusRoute       = api("/api/status/view");
export const deleteStatusRoute     = (id) => api(`/api/status/${id}`);
